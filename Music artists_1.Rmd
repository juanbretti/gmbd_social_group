...
g_undirected <- as.undirected(g, mode='collapse', edge.attr.comb="min")
...
g_communities <- cluster_louvain(g_undirected, weights=E(g_undirected)$influencer_active_start)
```
